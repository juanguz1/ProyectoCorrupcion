		...
		<div class="panel-body">
			<div class="row">
				...
				<div class="modal-body">
					...
					<form role="form" action="buscar_implicados" method="post">


							<div class="form-group">
								<label for="inputEmail3" class="col-sm-7 control-labe">Clave de caso a buscar <span style="color:red;">*</span></label>
								<div class="col-sm-10">
									<input  name="idCaso" id="idCaso" required>
